...
require (
	github.com/algorand/go-algorand-sdk latest
...
replace (
	github.com/algorand/go-algorand-sdk latest => github.com/almog-t/go-algorand-sdk 5abab22f5cc31e0bcd433615ff44cb2a50f36b13
)